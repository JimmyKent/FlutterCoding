...
class InnerWidgetsFlutterBinding extends WidgetsFlutterBinding {
  ...
  static void initPixel(int uiWidth, double uiRatio) {
    InnerPixelUtil.initPixel(uiWidth, uiRatio);
  }
  ...
  ViewConfiguration createViewConfiguration() {
    return ViewConfiguration(
      // 保证页面的虚拟大小和缩放比例
      size: window.physicalSize / InnerPixelUtil.getPixelRatio(),
      devicePixelRatio: InnerPixelUtil.getPixelRatio(),
    );
  }
...
class InnerPixelUtil {
  ...
  static double getPixelRatio() {
    return _uiRatio / getPixelRate();
  }

  /// 设计稿px和屏幕物理屏幕px之比
  static double getPixelRate() {
